# OPAM for fedora-24 with local switch of OCaml 4.05.0
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:fedora-24
LABEL distro_style="yum" distro="fedora" distro_long="fedora-24" arch="x86_64" ocaml_version="4.05.0" opam_version="1.2" operatingsystem="linux"
