# OPAM for oraclelinux-7 with local switch of OCaml 4.00.1
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:oraclelinux-7
LABEL distro_style="yum" distro="oraclelinux" distro_long="oraclelinux-7" arch="x86_64" ocaml_version="4.00.1" opam_version="1.2" operatingsystem="linux"
RUN rpm --rebuilddb && yum install -y sudo passwd bzip2 patch nano git which tar wget xz && yum clean all && \
