# OPAM for debian-9 with local switch of OCaml 4.06.0
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:debian-9
LABEL distro_style="apt" distro="debian" distro_long="debian-9" arch="x86_64" ocaml_version="4.06.0" opam_version="1.2" operatingsystem="linux"
