# OPAM for fedora-25 with local switch of OCaml 4.06.0+flambda
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:fedora-25
LABEL distro_style="yum" distro="fedora" distro_long="fedora-25" arch="x86_64" ocaml_version="4.06.0+flambda" opam_version="1.2" operatingsystem="linux"
...
RUN mkdir .ssh && \
  ...
  sudo -u opam sh -c "opam init -a -y --comp 4.06.0+flambda /home/opam/opam-repository" && \
