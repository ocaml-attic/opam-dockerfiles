# OPAM for fedora-23 with local switch of OCaml 4.03.0
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:fedora-23
LABEL distro_style="yum" distro="fedora" distro_long="fedora-23" arch="x86_64" ocaml_version="4.03.0" opam_version="1.2" operatingsystem="linux"
