# OPAM for opensuse-42.2 with local switch of OCaml 4.06.0+flambda
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:opensuse-42.2
LABEL distro_style="zypper" distro="opensuse" distro_long="opensuse-42.2" arch="x86_64" ocaml_version="4.06.0+flambda" opam_version="1.2" operatingsystem="linux"
