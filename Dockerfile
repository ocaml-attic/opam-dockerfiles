# OPAM for fedora-24 with local switch of OCaml 4.03.0+flambda
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:fedora-24
LABEL distro_style="yum" distro="fedora" distro_long="fedora-24" arch="x86_64" ocaml_version="4.03.0+flambda" opam_version="1.2" operatingsystem="linux"
RUN rpm --rebuilddb && yum install -y sudo passwd bzip2 gcc-c++ patch nano git which tar wget xz redhat-rpm-config && yum clean all && \
