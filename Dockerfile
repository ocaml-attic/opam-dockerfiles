# OPAM for debian-10 with local switch of OCaml 4.06.0+flambda
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:debian-10
LABEL distro_style="apt" distro="debian" distro_long="debian-10" arch="x86_64" ocaml_version="4.06.0+flambda" opam_version="1.2" operatingsystem="linux"
