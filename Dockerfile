# OPAM for alpine-3.5 with local switch of OCaml 4.05.0
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:alpine-3.5
LABEL distro_style="apk" distro="alpine" distro_long="alpine-3.5" arch="x86_64" ocaml_version="4.05.0" opam_version="1.2" operatingsystem="linux"
