# OPAM for centos-6 with local switch of OCaml 4.04.1
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:centos-6
LABEL distro_style="yum" distro="centos" distro_long="centos-6" arch="x86_64" ocaml_version="4.04.1" opam_version="1.2" operatingsystem="linux"
