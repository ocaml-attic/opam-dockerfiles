# OPAM for oraclelinux-7 with local switch of OCaml 4.04.2+flambda
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:oraclelinux-7
LABEL distro_style="yum" distro="oraclelinux" distro_long="oraclelinux-7" arch="x86_64" ocaml_version="4.04.2+flambda" opam_version="1.2" operatingsystem="linux"
