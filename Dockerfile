# OPAM for ubuntu-17.04 with local switch of OCaml 4.05.0+flambda
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:ubuntu-17.04
LABEL distro_style="apt" distro="ubuntu" distro_long="ubuntu-17.04" arch="x86_64" ocaml_version="4.05.0+flambda" opam_version="1.2" operatingsystem="linux"
