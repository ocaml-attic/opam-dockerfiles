# OPAM for alpine with local switch of OCaml 4.06.0
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:alpine
LABEL distro_style="apk" distro="alpine" distro_long="alpine" arch="x86_64" ocaml_version="4.06.0" opam_version="1.2" operatingsystem="linux"
