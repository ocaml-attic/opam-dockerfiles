# OPAM for alpine-armhf with local switch of OCaml 4.05.0+trunk+flambda
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:alpine-armhf
LABEL distro_style="apk" distro="alpine-armhf" distro_long="alpine-armhf" arch="armv7" ocaml_version="4.05.0+flambda" opam_version="1.2" operatingsystem="linux"
...
RUN mkdir .ssh && \
  ...
  sudo -u opam sh -c "opam init -a -y --comp 4.05.0+trunk+flambda /home/opam/opam-repository" && \
