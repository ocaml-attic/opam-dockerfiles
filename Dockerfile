# OPAM for fedora-22 with local switch of OCaml 4.04.0
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:fedora-22
LABEL distro_style="yum" distro="fedora" distro_long="fedora-22" arch="x86_64" ocaml_version="4.04.0" opam_version="1.2" operatingsystem="linux"
...
RUN mkdir .ssh && \
  ...
  sudo -u opam sh -c "opam init -a -y --comp 4.04.0 /home/opam/opam-repository" && \
