# OPAM for alpine-armhf-3.4 with local switch of OCaml 4.04.0
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:alpine-armhf-3.4
LABEL distro_style="apk" distro="alpine-armhf" distro_long="alpine-armhf-3.4" arch="armv7" ocaml_version="4.04.0" opam_version="1.2" operatingsystem="linux"
