# OPAM for fedora-25 with system OCaml compiler
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:fedora-25
LABEL distro_style="yum" distro="fedora" distro_long="fedora-25" arch="x86_64" ocaml_version="4.02.3" opam_version="1.2" operatingsystem="linux"
