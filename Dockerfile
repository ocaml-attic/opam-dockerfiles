# OPAM for debian-testing with local switch of OCaml 4.00.1
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:debian-testing
LABEL distro_style="apt" distro="debian" distro_long="debian-testing" arch="x86_64" ocaml_version="4.00.1" opam_version="1.2" operatingsystem="linux"
