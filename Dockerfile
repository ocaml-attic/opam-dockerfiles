# OPAM for alpine-armhf with system OCaml compiler
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:alpine-armhf
LABEL distro_style="apk" distro="alpine-armhf" distro_long="alpine-armhf" arch="armv7" ocaml_version="4.02.3" opam_version="1.2" operatingsystem="linux"
