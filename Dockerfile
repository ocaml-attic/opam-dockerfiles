# OPAM for alpine-armhf with local switch of OCaml 4.05.0+trunk
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:alpine-armhf
LABEL distro_style="apk" distro="alpine-armhf" distro_long="alpine-armhf" arch="armv7" ocaml_version="4.05.0" opam_version="1.2" operatingsystem="linux"
...
RUN mkdir .ssh && \
  ...
  sudo -u opam sh -c "opam init -a -y --comp 4.05.0+trunk /home/opam/opam-repository" && \
