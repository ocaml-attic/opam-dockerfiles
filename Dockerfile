# OPAM for opensuse-42.1 with local switch of OCaml 4.06.0
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:opensuse-42.1
LABEL distro_style="zypper" distro="opensuse" distro_long="opensuse-42.1" arch="x86_64" ocaml_version="4.06.0" opam_version="1.2" operatingsystem="linux"
