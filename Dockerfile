# OPAM for ubuntu-16.10 with local switch of OCaml 4.04.1
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:ubuntu-16.10
LABEL distro_style="apt" distro="ubuntu" distro_long="ubuntu-16.10" arch="x86_64" ocaml_version="4.04.1" opam_version="1.2" operatingsystem="linux"
