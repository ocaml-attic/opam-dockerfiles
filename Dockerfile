# OPAM for fedora-22 with local switch of OCaml 4.04.1
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:fedora-22
LABEL distro_style="yum" distro="fedora" distro_long="fedora-22" arch="x86_64" ocaml_version="4.04.1" opam_version="1.2" operatingsystem="linux"
