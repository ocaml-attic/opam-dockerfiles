# OPAM for raspbian-8 with system OCaml compiler
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:raspbian-8
LABEL distro_style="apt" distro="raspbian" distro_long="raspbian-8" arch="armv7" ocaml_version="4.01.0" opam_version="1.2" operatingsystem="linux"
