# OPAM for debian-unstable with local switch of OCaml 4.04.2
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:debian-unstable
LABEL distro_style="apt" distro="debian" distro_long="debian-unstable" arch="x86_64" ocaml_version="4.04.2" opam_version="1.2" operatingsystem="linux"
