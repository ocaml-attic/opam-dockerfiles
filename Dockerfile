# OPAM for alpine-armhf-3.4 with local switch of OCaml 4.05.0+trunk+flambda
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:alpine-armhf-3.4
LABEL distro_style="apk" distro="alpine-armhf" distro_long="alpine-armhf-3.4" arch="armv7" ocaml_version="4.05.0+flambda" opam_version="1.2" operatingsystem="linux"
