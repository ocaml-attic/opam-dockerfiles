# OPAM for centos-7 with local switch of OCaml 4.04.0+flambda
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:centos-7
LABEL distro_style="yum" distro="centos" distro_long="centos-7" arch="x86_64" ocaml_version="4.04.0+flambda" opam_version="1.2" operatingsystem="linux"
