# OPAM for debian-stable with local switch of OCaml 4.06.0
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:debian-stable
LABEL distro_style="apt" distro="debian" distro_long="debian-stable" arch="x86_64" ocaml_version="4.06.0" opam_version="1.2" operatingsystem="linux"
