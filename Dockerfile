# OPAM for debian-unstable with system OCaml compiler
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:debian-unstable
LABEL distro_style="apt" distro="debian" distro_long="debian-unstable" arch="x86_64" ocaml_version="4.02.3" opam_version="1.2" operatingsystem="linux"
