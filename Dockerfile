# OPAM for alpine-3.3 with system OCaml compiler
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:alpine-3.3
LABEL distro_style="apk" distro="alpine" distro_long="alpine-3.3" arch="x86_64" ocaml_version="4.02.3" opam_version="1.2" operatingsystem="linux"
