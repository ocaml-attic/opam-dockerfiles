# OPAM for ubuntu-12.04 with local switch of OCaml 4.04.2+flambda
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:ubuntu-12.04
LABEL distro_style="apt" distro="ubuntu" distro_long="ubuntu-12.04" arch="x86_64" ocaml_version="4.04.2+flambda" opam_version="1.2" operatingsystem="linux"
