# OPAM for debian-8 with local switch of OCaml 4.04.0
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:debian-8
LABEL distro_style="apt" distro="debian" distro_long="debian-8" arch="x86_64" ocaml_version="4.04.0" opam_version="1.2" operatingsystem="linux"
