# OPAM for ubuntu-14.04 with local switch of OCaml 4.06.0
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:ubuntu-14.04
LABEL distro_style="apt" distro="ubuntu" distro_long="ubuntu-14.04" arch="x86_64" ocaml_version="4.06.0" opam_version="1.2" operatingsystem="linux"
