# OPAM for alpine-3.6 with local switch of OCaml 4.06.0
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:alpine-3.6
LABEL distro_style="apk" distro="alpine" distro_long="alpine-3.6" arch="x86_64" ocaml_version="4.06.0" opam_version="1.2" operatingsystem="linux"
