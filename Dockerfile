# OPAM for raspbian-7 with local switch of OCaml 4.02.3
# Autogenerated by OCaml-Dockerfile scripts
FROM ocaml/ocaml:raspbian-7
LABEL distro_style="apt" distro="raspbian" distro_long="raspbian-7" arch="armv7" ocaml_version="4.02.3" opam_version="1.2.2" operatingsystem="linux"
