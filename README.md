...
------------ | ------------------ | -------
Debian | 4.01.0 &#127362;, 4.04.1 &#127347; | `docker pull ocaml/opam`
...
Distribution | Available Switches | Command
------------ | ------------------ | -------
Alpine | 4.04.0 &#127362;, 4.04.1 &#127347; | `docker pull ocaml/opam:alpine`
CentOS | 4.01.0 &#127362;, 4.04.1 &#127347; | `docker pull ocaml/opam:centos`
Debian | 4.01.0 &#127362;, 4.04.1 &#127347; | `docker pull ocaml/opam:debian`
Fedora | 4.02.3 &#127362;, 4.04.1 &#127347; | `docker pull ocaml/opam:fedora`
OpenSUSE | 4.03.0 &#127362;, 4.04.1 &#127347; | `docker pull ocaml/opam:opensuse`
OracleLinux | 4.04.1 &#127347; | `docker pull ocaml/opam:oraclelinux`
Ubuntu | 4.02.3 &#127362;, 4.04.1 &#127347; | `docker pull ocaml/opam:ubuntu`
...
Alpine 3.3 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:alpine-3.3_ocaml-4.04.1_flambda`
...
Alpine 3.4 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:alpine-3.4_ocaml-4.04.1_flambda`
...
Alpine 3.5 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:alpine-3.5_ocaml-4.04.1_flambda`
...
Alpine Stable (3.5) | 4.00.1 &#127347; | `docker pull ocaml/opam:alpine_ocaml-4.00.1`
Alpine Stable (3.5) | 4.01.0 &#127347; | `docker pull ocaml/opam:alpine_ocaml-4.01.0`
Alpine Stable (3.5) | 4.02.3 &#127347; | `docker pull ocaml/opam:alpine_ocaml-4.02.3`
Alpine Stable (3.5) | 4.03.0 &#127347; | `docker pull ocaml/opam:alpine_ocaml-4.03.0`
Alpine Stable (3.5) | 4.03.0+flambda &#127347; | `docker pull ocaml/opam:alpine_ocaml-4.03.0_flambda`
Alpine Stable (3.5) | 4.04.0 &#127362;&#127347; | `docker pull ocaml/opam:alpine_ocaml-4.04.0`
Alpine Stable (3.5) | 4.04.0+flambda &#127347; | `docker pull ocaml/opam:alpine_ocaml-4.04.0_flambda`
Alpine Stable (3.5) | 4.04.1 &#127347; | `docker pull ocaml/opam:alpine_ocaml-4.04.1`
Alpine Stable (3.5) | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:alpine_ocaml-4.04.1_flambda`
Alpine Stable (3.5) | 4.05.0 &#127347; | `docker pull ocaml/opam:alpine_ocaml-4.05.0`
Alpine Stable (3.5) | 4.05.0+flambda &#127347; | `docker pull ocaml/opam:alpine_ocaml-4.05.0_flambda`
Alpine Stable (3.5) | 4.06.0 &#127347; | `docker pull ocaml/opam:alpine_ocaml-4.06.0`
Alpine Stable (3.5) | 4.06.0+flambda &#127347; | `docker pull ocaml/opam:alpine_ocaml-4.06.0_flambda`
...
CentOS 6 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:centos-6_ocaml-4.04.1_flambda`
...
CentOS 7 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:centos-7_ocaml-4.04.1_flambda`
...
Debian 7 (Wheezy) | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:debian-7_ocaml-4.04.1_flambda`
...
Debian 8 (Jessie) | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:debian-8_ocaml-4.04.1_flambda`
...
Debian 9 (Stretch) | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:debian-9_ocaml-4.04.1_flambda`
...
Debian Stable | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:debian-stable_ocaml-4.04.1_flambda`
...
Debian Testing | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:debian-testing_ocaml-4.04.1_flambda`
...
Debian Unstable | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:debian-unstable_ocaml-4.04.1_flambda`
...
Fedora 22 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:fedora-22_ocaml-4.04.1_flambda`
...
Fedora 23 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:fedora-23_ocaml-4.04.1_flambda`
...
Fedora 24 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:fedora-24_ocaml-4.04.1_flambda`
...
Fedora 25 | 4.04.0+flambda &#127347; | `docker pull ocaml/opam:fedora-25_ocaml-4.04.0_flambda`
Fedora 25 | 4.04.1 &#127347; | `docker pull ocaml/opam:fedora-25_ocaml-4.04.1`
Fedora 25 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:fedora-25_ocaml-4.04.1_flambda`
...
OpenSUSE 42.1 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:opensuse-42.1_ocaml-4.04.1_flambda`
...
OpenSUSE 42.2 | 4.04.0+flambda &#127347; | `docker pull ocaml/opam:opensuse-42.2_ocaml-4.04.0_flambda`
OpenSUSE 42.2 | 4.04.1 &#127347; | `docker pull ocaml/opam:opensuse-42.2_ocaml-4.04.1`
OpenSUSE 42.2 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:opensuse-42.2_ocaml-4.04.1_flambda`
...
OracleLinux 7 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:oraclelinux-7_ocaml-4.04.1_flambda`
...
Ubuntu 12.04 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:ubuntu-12.04_ocaml-4.04.1_flambda`
...
Ubuntu 14.04 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:ubuntu-14.04_ocaml-4.04.1_flambda`
...
Ubuntu 16.04 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:ubuntu-16.04_ocaml-4.04.1_flambda`
...
Ubuntu 16.10 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:ubuntu-16.10_ocaml-4.04.1_flambda`
...
Ubuntu 17.04 | 4.04.0+flambda &#127347; | `docker pull ocaml/opam:ubuntu-17.04_ocaml-4.04.0_flambda`
Ubuntu 17.04 | 4.04.1 &#127347; | `docker pull ocaml/opam:ubuntu-17.04_ocaml-4.04.1`
Ubuntu 17.04 | 4.04.1+flambda &#127347; | `docker pull ocaml/opam:ubuntu-17.04_ocaml-4.04.1_flambda`
